...
from mcsmoe.merging.grouping_deepseekv2 import ExpertsGrouperForDeepseekV2, merge_by_groups_with_usage_weighted


DEEPSEEPV2_MODEL_PATH = '/opt/data/private/hyy/hf_models/DeepSeek-V2-Lite-Chat'
...
def evaluate_mcsmoe(
    ...
    grouper = ExpertsGrouperForDeepseekV2(config=model.config, similarity_base="router-logits")
